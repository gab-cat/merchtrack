...
const HeaderLP = () => {
  ...
  return (
    <nav className='border-b'>
      <div className="max-w-screen-lg flex flex-row flex-wrap mx-auto items-center justify-between p-2">
        ...
        <div className="flex md:order-2 space-x-3">
          <SignInButton mode='modal'>
            <button className="text-primary bg-neutral-1  focus:ring-4 focus:outline-none focus:ring-accent-7 font-medium rounded-lg text-sm px-4 py-2 text-center hidden md:flex w-max outline outline-1 outline-primary hover:opacity-70">Sign In</button>
          </SignInButton>
          ...
          <button data-collapse-toggle="navbar-cta" onClick={handleNavPress} type="button" className="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 border" aria-controls="navbar-cta" aria-expanded="false">
